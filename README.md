...
Щоб запустити лабораторну роботу потрібно:
1) git clone https://github.com/denysvedernikov02/JavaLabs.git
2) Відкрити App.java за допомогою будь-якого idea, який підтримує java
3) Зкомпілювати код і запустити його